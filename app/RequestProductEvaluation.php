...
class RequestProductEvaluation extends Model implements Auditable
{
    ...
    public function rpe_personnels() 
    {
        return $this->belongsTo(RpePersonnel::class, 'id', 'RequestProductEvaluationId');
    }
    ...
    public function rpeFiles()
    {
        return $this->hasMany(RpeFile::class, 'RequestProductEvaluationId', 'id');
    }
