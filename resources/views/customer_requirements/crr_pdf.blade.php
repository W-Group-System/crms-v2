...
<body>
    ...
    <div class="page-break">
        <table border="1" style="width: 100%; font-size:9" cellspacing="0" cellpadding="0">
            ...
            <table border="0" style="width: 100%; font-size:9;" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="5">
                        <p class="ml-5">{!! nl2br($crr->DetailsOfRequirement) !!}</p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 50;">
                        <input type="checkbox"> <small>Code</small>
                    </td>
                    <td style="padding-top: 50;">
            ...
            <table border="0" style="width: 100%; font-size:9;" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="5" height="200" valign="top">
                        {{-- <p>{!! nl2br($crr->DetailsOfRequirement) !!}</p> --}}
