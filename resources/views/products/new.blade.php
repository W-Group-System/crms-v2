...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card rounded-0 border border-primary border-1">
        <div class="card-header rounded-0 bg-primary font-weight-bold text-white">
            <p class="m-0">List of Products (New)</p>
        </div>
        <div class="card-body">
