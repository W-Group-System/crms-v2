                        ...
                        <table class="table table-bordered mb-3" style="background: rgb(255 255 255 / 91%)">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-p1" name="check_p1" type="checkbox" @if($data->product_quality === null || $data->product_quality === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-p2" name="check_p2" type="checkbox" @if($data->product_quality === null || $data->product_quality === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-p3" name="check_p3" type="checkbox"  @if($data->product_quality === null || $data->product_quality === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-p4" name="check_p4" type="checkbox"  @if($data->product_quality === null || $data->product_quality === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-p5" name="check_p5" type="checkbox"  @if($data->product_quality === null || $data->product_quality === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-p6" name="check_p6" type="checkbox"  @if($data->product_quality === null || $data->product_quality === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-pack1" name="check-pack1" type="checkbox" @if($data->packaging === null || $data->packaging === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-pack2" type="checkbox" @if($data->packaging === null || $data->packaging === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-pack3" type="checkbox" @if($data->packaging === null || $data->packaging === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-pack4" type="checkbox" @if($data->packaging === null || $data->packaging === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-d1" name="check-d1" type="checkbox" @if($data->delivery_handling === null || $data->delivery_handling === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-d2" name="check-d2" type="checkbox" @if($data->delivery_handling === null || $data->delivery_handling === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-d3" name="check-d3" type="checkbox" @if($data->delivery_handling === null || $data->delivery_handling === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-o1" name="check-o1" type="checkbox" @if($data->others === null || $data->packaging === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-o2" name="check-o2" type="checkbox" @if($data->others === null || $data->packaging === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-o3" name="check-o3" type="checkbox" @if($data->others === null || $data->packaging === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-o4" name="check-o4" type="checkbox" @if($data->others === null || $data->packaging === '') unchecked @else checked @endif></td>
