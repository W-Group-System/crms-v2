                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="Currency" id="Currency" value="{{ $data->Currency }}" placeholder="Enter Currency">
                            </div>
                        </div> 
                    </div>
                        ...
                        <table class="table table-bordered mb-3" style="background: rgb(255 255 255 / 91%)">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-p1" name="check_p1" type="checkbox" @if(optional($data->product_quality)->ScNo1 === null || optional($data->product_quality)->ScNo1 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-p2" name="check_p2" type="checkbox" @if(optional($data->product_quality)->Pn2 === null || optional($data->product_quality)->Pn2 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-p3" name="check_p3" type="checkbox"  @if(optional($data->product_quality)->Pn3 === null || optional($data->product_quality)->Pn3 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-p4" name="check_p4" type="checkbox"  @if(optional($data->product_quality)->Pn4 === null || optional($data->product_quality)->Pn4 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-p5" name="check_p5" type="checkbox"  @if(optional($data->product_quality)->Pn5 === null || optional($data->product_quality)->Pn5 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-p6" name="check_p6" type="checkbox"  @if(optional($data->product_quality)->Pn6 === null || optional($data->product_quality)->Pn6 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-pack1" name="check-pack1" type="checkbox" @if(optional($data->packaging)->PackPn1 === null || optional($data->packaging)->PackPn1 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-pack2" type="checkbox" @if(optional($data->packaging)->PackPn2 === null || optional($data->packaging)->PackPn2 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-pack3" type="checkbox" @if(optional($data->packaging)->PackPn3 === null || optional($data->packaging)->PackPn3 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-pack4" type="checkbox" @if(optional($data->packaging)->PackPn4 === null || optional($data->packaging)->PackPn4 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-d1" name="check-d1" type="checkbox" @if(optional($data->delivery_handling)->DhPn1 === null || optional($data->delivery_handling)->DhPn1 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-d2" name="check-d2" type="checkbox" @if(optional($data->delivery_handling)->DhPn2 === null || optional($data->delivery_handling)->DhPn2 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-d3" name="check-d3" type="checkbox" @if(optional($data->delivery_handling)->DhPn3 === null || optional($data->delivery_handling)->DhPn3 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-o1" name="check-o1" type="checkbox" @if(optional($data->others)->OthersPn1 === null || optional($data->others)->OthersPn1 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-o2" name="check-o2" type="checkbox" @if(optional($data->others)->OthersPn2 === null || optional($data->others)->OthersPn2 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-o3" name="check-o3" type="checkbox" @if(optional($data->others)->OthersPn3 === null || optional($data->others)->OthersPn3 === '') unchecked @else checked @endif></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input id="check-o4" name="check-o4" type="checkbox" @if(optional($data->others)->OthersPn4 === null || optional($data->others)->OthersPn4 === '') unchecked @else checked @endif></td>
