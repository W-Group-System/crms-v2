    ...
    <div class="content">
        ...
        <table border="0" style="width: 100%; font-size:9; height:min-content;border: #000 solid 1px;" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td width="30%">
                    <p class="ml-1 text-left"><strong class="d-inline-block" style="border-bottom: 1px dashed black; width:100%;">
                    @if($product_evaluations->CreatedDate != null)
                        {{ date('M d, Y h:i A', strtotime($product_evaluations->CreatedDate)) }}
                    @else
                        {{ date('M d, Y h:i A', strtotime($product_evaluations->created_at)) }}
                    @endif
                    </strong></p>
                </td>
                <td width="25%">
