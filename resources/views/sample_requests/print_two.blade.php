    ...
    <table border="1" style="width: 100%; font-size:9 margin-top:0; height:min-content;" cellspacing="0" cellpadding="0">
        ...
        <table border="0" style="width: 100%; font-size:9; height:min-content;" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td width="25%">
                    <p class="ml-1 text-center"><strong class="d-inline-block" style="border-bottom: 1px dashed black; width:100%;">
                            ...
                            @elseif($sample_requests->RefCode == 2)
                                QCD-WHI
                            @elseif($sample_requests->RefCode == 3)
                                QCD-PBI
                            @elseif($sample_requests->RefCode == 4)
                                QCD-MRDC
                            @elseif($sample_requests->RefCode == 5)
                                QCD-CCC
                            @else
                                {{ $sample_requests->RefCode }}
                            @endif
            ...
            <tr>
                ...
                <td width="30%">
                    <p class="ml-1 text-left"><span class="d-inline-block" style="border-bottom: 1px dashed black; width:100%; font-size:10px; white-space: pre-line; font-family: DejaVu Sans, sans-serif; line-height: 11px;">{{ optional($sample_requests->clientAddress)->Address }}</span></p>
                </td>
                <td width="25%">
                    <p class="text-right"></p> 
                </td>
