            ...
            <form method="POST" id="edit_sample_request{{$sampleRequest->Id }}" enctype="multipart/form-data" action="{{ url('sample_request/edit/' .$sampleRequest->Id) }}">
                ...
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control js-example-basic-single" name="PrimarySalesPerson" style="position: relative !important" title="Select PrimarySalesPerson" >
                            ...
                            @foreach ($primarySalesPersons as $salesPerson)
                                <option value="{{ $salesPerson->user_id }}" @if (old('PrimarySalesPerson',  $sampleRequest->PrimarySalesPersonId) == $salesPerson->user_id) selected @endif>{{ $salesPerson->full_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control js-example-basic-single" name="SecondarySalesPerson" style="position: relative !important" title="Select SecondarySalesPerson" >
                            ...
                            @foreach ($secondarySalesPersons as $salesPerson)
                                <option value="{{ $salesPerson->user_id }}"  @if (old('SecondarySalesPerson',  $sampleRequest->SecondarySalesPersonId) == $salesPerson->user_id) selected @endif>{{ $salesPerson->full_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Client:</label>
                            <select class="form-control js-example-basic-single editClientId{{$sampleRequest->Id }}" name="ClientId" id="" style="position: relative !important" title="Select ClientId">
