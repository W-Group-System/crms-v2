<div class="modal fade" id="editSrfPersonnel{{ $Personnel->Id }}" tabindex="-1" role="dialog" aria-labelledby="Personnel Update" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="form_sample_request" enctype="multipart/form-data" action="{{ url('UpdateAssignedPersonnel/'.$Personnel->Id) }}">
                    @csrf
