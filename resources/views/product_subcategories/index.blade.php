...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card border border-1 border-primary rounded-0">
        <div class="card-header bg-primary">
            <p class="m-0 text-white font-weight-bold">List of Application Subcategories</p>
        </div>
        <div class="card-body">
            {{-- <h4 class="card-title d-flex justify-content-between align-items-center">
                Application Sub Categories
            </h4> --}}
            <button type="button" class="btn btn-md btn-outline-primary float-right" data-toggle="modal" data-target="#formProductSubcategories" id="addBtn">New</button>
