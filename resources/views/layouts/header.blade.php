                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    ...
                    <ul class="nav mt-2">
                        <li class="nav-item">
                            ...
                            @elseif(Auth::check() && optional(Auth::user()->role)->type == 'QCD-WHI' || optional(Auth::user()->role)->type == 'QCD-PBI' || optional(Auth::user()->role)->type == 'QCD-MRDC' || optional(Auth::user()->role)->type == 'QCD-CCC' || optional(Auth::user()->role)->type == 'Production')
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="table_service">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    @endif --}}
                                    <!-- @if(viewModule('Customer Feedback', $department, $role) == "yes") -->
                                        <li class="nav-item"> <a class="nav-link" href="{{ url('/cs_list?open=10') }}">Customer Satisfaction</a></li>
                                    @endif
                                    @if(viewModule('Customer Complaints', $department, $role) == "yes")
                                        <li class="nav-item"> <a class="nav-link" href="{{ url('/cc_list?open=10') }}">Customer Complaint</a></li>
                                    @endif
                                    @if((viewModule('Issue Category', $department, $role) == "yes") || (viewModule('Concerned Department', $department, $role) == "yes"))
                                        <li class="nav-item">
