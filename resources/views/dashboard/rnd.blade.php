...
<div class="content-wrapper">
    ...
    <div class="row">
        @if ((optional($role)->name == 'Staff L2' || optional($role)->name == 'Department Admin') && (optional($role)->type == 'RND'))
            ...
            <div class="col-lg-6 mb-2">
                <div class="card rounded-0 border border-1 border-danger">
                    <div class="card-body bg-danger">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <h1 class="m-0 text-right text-white">{{$total_close_transaction}}</h1>
                                <p class="m-0 text-right text-white">Closed Transactions</p>
                            </div>
                        </div>
                    </div>
                    <a href="{{url('close-transaction')}}" class="text-decoration-none">
                        <div class="card-footer p-2">
                            <div class="row">
                                <div class="col-lg-6">
                                    <p class="m-0 text-danger">View Details</p>
                                </div>
                                <div class="col-lg-6 text-right">
                                    <i class="ti-arrow-circle-right text-danger"></i>
                                </div>
                            </div>
                        </div>
                    </a>
