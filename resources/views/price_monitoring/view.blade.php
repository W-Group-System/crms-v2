        ...
        <div class="card-body">
          ...
          @endforeach
            ...
            <ul class="nav nav-tabs" id="productTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="prfFiles-tab" data-toggle="tab" href="#prfFiles" role="tab" aria-controls="files" aria-selected="false">Files</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade" id="prfFiles" role="tabpanel" aria-labelledby="prfFiles-tab">
                    <div class="d-flex">
    ...
    function confirmDelete(id, type) {
        Swal.fire({
            ...
            if (type === 'supplementary') {
                url = '{{ url('price_monitorings/view/supp-delete') }}/' + id;
...
@include('sample_requests.edit_prfFiles')
@endforeach
